...
CREATE TABLE dbo.TBL_ALIMENTO_RESTRITIVO
(
	CD_ALIMENTO_RESTRITIVO INT IDENTITY(1,1) NOT NULL,
	DS_ALIMENTO            VARCHAR(300) NOT NULL,
	CONSTRAINT TBL_ALIMENTO_RESTRITIVO PRIMARY KEY (CD_ALIMENTO_RESTRITIVO)
)
GO

CREATE TABLE dbo.TBL_PRODUTO_ALIMENTO_RESTRITIVO
(
	CD_PRODUTO_ALIMENTO_RESTRITIVO INT IDENTITY(1,1) NOT NULL,
	CD_PRODUTO                     INT NOT NULL,
	CD_ALIMENTO_RESTRITIVO         INT NOT NULL,
	CONSTRAINT PK_TBL_PRODUTO_ALIMENTO_RESTRITIVO    PRIMARY KEY (CD_PRODUTO_ALIMENTOS_RESTRITIVOS),
	CONSTRAINT FK_TBL_PRODUTO_ALIMENTO_RESTRITIVO_TBL_PRODUTOS FOREIGN KEY (CD_PRODUTOS) REFERENCES dbo.TBL_PRODUTOS (CD_PRODUTOS),
	CONSTRAINT FK_TBL_PRODUTO_ALIMENTO_RESTRITIVO_TBL_ALIMENTO_RESTRITIVO FOREIGN KEY (CD_ALIMENTO_RESTRITIVO) REFERENCES dbo.TBL_ALIMENTO_RESTRITIVO (CD_ALIMENTO_RESTRITIVO) 
)
GO
